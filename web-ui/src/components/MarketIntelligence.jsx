...
export default function MarketIntelligence() {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 space-y-6">
      <div className="text-xl font-bold text-white mb-4">Market Intelligence</div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="border border-brand-border bg-brand-card p-4 rounded-xl">
          ...
          <div className="text-2xl font-bold text-white">{data.market_breadth}</div>
        </div>
        
        <div className="border border-brand-border bg-brand-card p-4 rounded-xl">
          <div className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mb-2">Sector Rotation</div>
          <div className="text-2xl font-bold text-white">{data.sector_rotation}</div>
        </div>
